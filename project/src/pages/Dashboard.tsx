...
import { Package, DollarSign, AlertTriangle, TrendingUp, ShoppingCart, Users, Truck, BarChart3, Clock } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 hover:bg-orange-100 transition-colors duration-200">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-orange-800">Reorder Point Reached</h4>
                  <p className="text-xs text-orange-600 mt-1">Product D needs restocking</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 hover:bg-blue-100 transition-colors duration-200">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-blue-800">Monthly Report Ready</h4>
                  <p className="text-xs text-blue-600 mt-1">September sales report is available</p>
                </div>
              </div>
            </div>
          </div>
